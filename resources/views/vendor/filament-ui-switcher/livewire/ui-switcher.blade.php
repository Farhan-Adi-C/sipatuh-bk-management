<div x-data="{
    ...
    >
        ...
        <div wire:loading.delay.shortest
            ...
            <span class="font-medium">{{ __('Loading...') }}</span>
        </div>
        ...
        <div class="space-y-8 py-4">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <button
                        ...
                        <span class="text-xs font-medium">{{ __('Sidebar & Topbar') }}</span>
                    </button>
                    ...
                    <button
                        ...
                        <span class="text-xs font-medium">{{ __('Compact') }}</span>
                    </button>
                    ...
                    <button
                        ...
                        <span class="text-xs font-medium text-center leading-tight">{{ __('Sidebar') }}</span>
                    </button>
                    ...
                    <button
                        ...
                        <span class="text-xs font-medium">{{ __('Topbar') }}</span>
                    </button>
                </div>
            </div>
            ...
            <div>
                ...
                <p class="text-xs text-gray-600 dark:text-gray-400 mb-3">{{ __('Font Family') }}</p>
            ...
            <div x-data="{
                ...
                <div class="flex items-center justify-between mb-3">
                    <p class="text-xs text-gray-600 dark:text-gray-400">{{ __('Ukuran Font') }}</p>
